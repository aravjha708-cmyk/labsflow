...
async function handleGoogleApiProxy(req, res) {
  ...
  if (targetUrl.includes('batchLogFrontendEvents') || targetUrl.includes('feedback-pa')) {
  ...
  try {
    ...
    if (req.headers['authorization']) {
      ...
      forwardHeaders['Authorization'] = config.apiToken.startsWith('Bearer ') || config.apiToken.startsWith('SAPISIDHASH ')
        ? config.apiToken
